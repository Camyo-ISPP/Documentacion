...
- **Designar a alguien como responsable de la conformidad**: Con el fin de crear, evaluar y aplicar medidas técnicas y organizativas con rigor, es necesario que alguien del grupo de desarrollo de Camyo se encargue de asegurar la conformidad con el RGPD y la LOPDGDD.
- **Obtener el consentimiento explícito**: Se debe informar a las personas usuarias de Camyo del uso de sus datos de catácter personal y obtener un consentimiento explícito e inequívoco, indicando qué datos se van a recopilar y con qué finalidad. El consentimiento se debe obtener mediante una declaración o una clara acción afirmativa y se podrá rechazar o retirar en cualquier momento. En caso de utilizar cookies de terceros para el rastreo o para mostrar publicidad, el consentimiento también será necesario para poder almacenar cookies no esenciales en el dispositivo del interesado.
- **Permitir el ejercicio de los derechos**: En el caso de Camyo, el derecho de acceso y rectificación se podrá ejercer desde la misma aplicación, a menos que se almacene más información de la que se muestra en el perfil de usuario, como la dirección IP con la que se realiza la conexión. En cualquier caso, se debe abrir un canal de comunicación con el interesado para permitir que este solicite ejercer sus derechos, especialmente para aquellos cuya provisión en la aplicación no es tan sencilla, como la portabilidad o la limitación al tratamiento.
- **Seudonimización**: La definición 5 del artículo 4 del RGPD establece la seudonimización como "el tratamiento de datos personales de manera tal que ya no puedan atribuirse a un interesado sin utilizar información adicional, siempre que dicha información adicional figure por separado y esté sujeta a medidas técnicas y organizativas destinadas a garantizar que los datos personales no se atribuyan a una persona física identificada o identificable". Esta es una opción recomendada para que el responsable y el encargado pueda cumplir las obligaciones en materia de protección de datos; concretamente, la protección desde el diseño, como recoge el artículo 25 del RGPD. Es necesario tener en cuenta que el método de seudonimización para usar no debe permitir que los datos personales puedan ser objeto de referencias cruzadas sin acceder a la información adicional almacenada por separado que permite reidentificar esos datos.
  - **Cifrado**: Mecanismo de seudonimización que hace incomprensibles los datos originales en un proceso que es irreversible sin acceso a la clave de descifrado.
- **Establecer protocolos de respuesta**: Es importante recordar que, en cualquier momento, un usuario puede solicitar la supresión de sus datos, retirar su consentimiento, o realizar cualquier otro ejercicio de sus derechos vía uno de los canales de comunicación establecidos. Por ello, el equipo debe saber cómo trabajar ante uno de estos supuestos y proporcionar al interesado una respuesta con la mayor brevedad.
  - **Notificar de violaciones de seguridad**: Sobre todo, hay que disponer de un plan de actuación en el caso de una violación de seguridad. No solo es fundamental informar a todos los usuarios afectados (esto se puede hacer por email o, excepcionalmente, por anuncio público) y a la Agencia Española de Protección de Datos, sino también adoptar medidas de protección adicionales.
